...
var landing_default = "/build/_assets/landing-EMBIHDPY.css";
...
function Skill({
  ...
  return /* @__PURE__ */ React.createElement("p", {
    className: `skill ${text} ${state.typing ? "typing" : ""}`
  }, state.textToDisplay);
}
